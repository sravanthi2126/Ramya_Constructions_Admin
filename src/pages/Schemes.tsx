    ...
    useForm<EditSchemeFormData>({
      defaultValues: {
        ...
        monthly_installment_amount:
          scheme.monthly_installment_amount ?? undefined,
  ...
  const onSubmit = async (formData: EditSchemeFormData) => {
    const data: UpdateSchemeRequest = {
      ...
      balance_payment_days:
        schemeType === "single_payment"
          ? formData.balance_payment_days ?? null
          : null,
      total_installments:
        schemeType === "installment"
          ? formData.total_installments ?? null
          : null,
      monthly_installment_amount:
        schemeType === "installment"
          ? formData.monthly_installment_amount ?? null
          : null,
    };
    ...
    try {
      ...
      toast({
        ...
        description: "Investment scheme has been successfully updated.",
      });
      setIsOpen(false);
      onSuccess();
    } catch (error: any) {
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 py-4">
          <div className="space-y-4">
            ...
            <div className="space-y-2 bg-gray-50 p-4 rounded-lg">
              <Label htmlFor="scheme_name" className="text-sm font-medium">
                Scheme Name
              </Label>
              <Input
                id="scheme_name"
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Select
                  onValueChange={(value) => {
                    setValue(
                      "scheme_type",
                      value as "single_payment" | "installment"
                    );
              ...
              <div className="space-y-2">
                <Label htmlFor="area_sqft" className="text-sm font-medium">
                  Area (Sqft)
                </Label>
                <Input
                  id="area_sqft"
  ...
  const handleDelete = async (schemeId: string) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Investment scheme has been deleted.",
      });
      fetchData();
    } catch (error: any) {
      ...
      toast({
        ...
        description:
          ...
          error.message ||
          "Failed to delete scheme. Please check if the scheme is in use.",
        variant: "destructive",
      });
    }
  };
      ...
      {schemes.length === 0 && (
        <div className="text-center py-12 bg-white rounded-xl shadow-md border border-gray-100">
          ...
          <p className="text-gray-500 text-sm mb-4">
            Get started by creating your first investment scheme
          </p>
          <AddSchemeDialog onSuccess={fetchData} />
        </div>
      )}
